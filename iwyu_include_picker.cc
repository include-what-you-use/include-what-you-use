...
const SymbolMapEntry libc_symbol_map[] = {
  ...
  // Manually map all numeric limits macros to <float.h>.
  { "DBL_DECIMAL_DIG", UseKind::Full, "<float.h>", kPublic },
  { "DBL_DIG", UseKind::Full, "<float.h>", kPublic },
  { "DBL_EPSILON", UseKind::Full, "<float.h>", kPublic },
  { "DBL_HAS_SUBNORM", UseKind::Full, "<float.h>", kPublic },
  { "DBL_MANT_DIG", UseKind::Full, "<float.h>", kPublic },
  { "DBL_MAX", UseKind::Full, "<float.h>", kPublic },
  { "DBL_MAX_10_EXP", UseKind::Full, "<float.h>", kPublic },
  { "DBL_MAX_EXP", UseKind::Full, "<float.h>", kPublic },
  { "DBL_MIN", UseKind::Full, "<float.h>", kPublic },
  { "DBL_MIN_10_EXP", UseKind::Full, "<float.h>", kPublic },
  { "DBL_MIN_EXP", UseKind::Full, "<float.h>", kPublic },
  { "DBL_SNAN", UseKind::Full, "<float.h>", kPublic },
  { "DBL_TRUE_MIN", UseKind::Full, "<float.h>", kPublic },
  { "DECIMAL_DIG", UseKind::Full, "<float.h>", kPublic },
  { "FLT_DECIMAL_DIG", UseKind::Full, "<float.h>", kPublic },
  { "FLT_DIG", UseKind::Full, "<float.h>", kPublic },
  { "FLT_EPSILON", UseKind::Full, "<float.h>", kPublic },
  { "FLT_EVAL_METHOD", UseKind::Full, "<float.h>", kPublic },
  { "FLT_HAS_SUBNORM", UseKind::Full, "<float.h>", kPublic },
  { "FLT_MANT_DIG", UseKind::Full, "<float.h>", kPublic },
  { "FLT_MAX", UseKind::Full, "<float.h>", kPublic },
  { "FLT_MAX_10_EXP", UseKind::Full, "<float.h>", kPublic },
  { "FLT_MAX_EXP", UseKind::Full, "<float.h>", kPublic },
  { "FLT_MIN", UseKind::Full, "<float.h>", kPublic },
  { "FLT_MIN_10_EXP", UseKind::Full, "<float.h>", kPublic },
  { "FLT_MIN_EXP", UseKind::Full, "<float.h>", kPublic },
  { "FLT_RADIX", UseKind::Full, "<float.h>", kPublic },
  { "FLT_ROUNDS", UseKind::Full, "<float.h>", kPublic },
  { "FLT_SNAN", UseKind::Full, "<float.h>", kPublic },
  { "FLT_TRUE_MIN", UseKind::Full, "<float.h>", kPublic },
  { "INFINITY", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_DECIMAL_DIG", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_DIG", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_EPSILON", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_HAS_SUBNORM", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_MANT_DIG", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_MAX", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_MAX_10_EXP", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_MAX_EXP", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_MIN", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_MIN_10_EXP", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_MIN_EXP", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_SNAN", UseKind::Full, "<float.h>", kPublic },
  { "LDBL_TRUE_MIN", UseKind::Full, "<float.h>", kPublic },
  { "NAN", UseKind::Full, "<float.h>", kPublic },
  // INFINITY and NAN are provided by math.h before C23, and allowed as a
  // provider in C23, so accept that as well.
  { "INFINITY", UseKind::Full, "<math.h>", kPublic },
  { "NAN", UseKind::Full, "<math.h>", kPublic },
};
