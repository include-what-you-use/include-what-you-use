...
tests/iwyu_stricter_than_cpp-typedefs.h should add these lines:
#include "tests/iwyu_stricter_than_cpp-i1.h"

tests/iwyu_stricter_than_cpp-typedefs.h should remove these lines:
- struct DirectStruct1;  // lines XX-XX
- template <typename T> struct TplDirectStruct1;  // lines XX-XX

The full include-list for tests/iwyu_stricter_than_cpp-typedefs.h:
