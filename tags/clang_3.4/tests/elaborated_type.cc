...
#include "tests/elaborated_type_enum1.h"  // for ElaborationEnum1
#include "tests/elaborated_type_enum2.h"  // for ElaborationEnum2
...
#include "tests/elaborated_type_namespace.h"
...
tests/elaborated_type.cc should add these lines:
...
tests/elaborated_type.cc should remove these lines:
- #include "tests/elaborated_type_class.h"  // lines XX-XX
- #include "tests/elaborated_type_namespace.h"  // lines XX-XX
- #include "tests/elaborated_type_struct.h"  // lines XX-XX
- #include "tests/elaborated_type_union.h"  // lines XX-XX

The full include-list for tests/elaborated_type.cc:
#include "tests/elaborated_type_enum1.h"  // for ElaborationEnum1
#include "tests/elaborated_type_enum2.h"  // for ElaborationEnum2
class ElaborationClass;
namespace Elaboration { class Class; }
