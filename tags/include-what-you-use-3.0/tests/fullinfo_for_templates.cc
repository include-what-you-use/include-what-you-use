...
#include "tests/fullinfo_for_templates-d1.h"
// Then include a file containing a forward declaration of TemplateClass.
#include "tests/fullinfo_for_templates-d2.h"
// IWYU requires full info when typedefing a template.
typedef TemplateClass<int> tc_int;

/**** IWYU_SUMMARY

tests/fullinfo_for_templates.cc should add these lines:

tests/fullinfo_for_templates.cc should remove these lines:
- #include "tests/fullinfo_for_templates-d2.h"  // lines XX-XX

The full include-list for tests/fullinfo_for_templates.cc:
#include "tests/fullinfo_for_templates-d1.h"  // for TemplateClass
