...
tests/depopulated_h_file.h should add these lines:

tests/depopulated_h_file.h should remove these lines:
- #include "tests/depopulated_h_file-i1.h"  // lines XX-XX

The full include-list for tests/depopulated_h_file.h:
