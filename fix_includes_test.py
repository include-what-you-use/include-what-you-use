...
"""
  ...
  def testPatchOutput(self):
    """Test the patch output generated by dry runs\
 when patch_relpath is specified."""
    infile = """
#include <notused.h>
...
"""
    iwyu_output = """\
/path/to/root/subdir/unified_diff.cc should add these lines:

/path/to/root/subdir/unified_diff.cc should remove these lines:
- #include <notused.h>  // lines 2-2

The full include-list for /path/to/root/subdir/unified_diff.cc:
---
"""
    diff_expect = """\
>>> Fixing #includes in '/path/to/root/subdir/unified_diff.cc'
--- a/subdir/unified_diff.cc
+++ b/subdir/unified_diff.cc
@@ -1,4 +1,2 @@
-
-#include <notused.h>
...
"""
    self.flags.dry_run = True
    self.flags.patch_relpath = "/path/to/root/"
    self.RegisterFileContents({'/path/to/root/subdir/unified_diff.cc': infile})
    self.ProcessAndTest(iwyu_output, unedited_files=['/path/to/root/subdir/unified_diff.cc'])
