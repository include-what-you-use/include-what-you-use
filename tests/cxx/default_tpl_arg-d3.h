...
tests/cxx/default_tpl_arg-d3.h should add these lines:
#include "tests/cxx/default_tpl_arg-i1.h"
#include "tests/cxx/indirect.h"

tests/cxx/default_tpl_arg-d3.h should remove these lines:
- #include "tests/cxx/default_tpl_arg-d1.h"  // lines XX-XX
- #include "tests/cxx/direct.h"  // lines XX-XX

The full include-list for tests/cxx/default_tpl_arg-d3.h:
