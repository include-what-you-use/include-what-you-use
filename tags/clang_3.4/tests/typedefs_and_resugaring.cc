...
#include "tests/typedefs_and_resugaring-d1.h"
...
tests/typedefs_and_resugaring.cc should add these lines:
#include "tests/indirect.h"

tests/typedefs_and_resugaring.cc should remove these lines:
- #include "tests/direct.h"  // lines XX-XX

The full include-list for tests/typedefs_and_resugaring.cc:
#include "tests/indirect.h"  // for IndirectClass
#include "tests/typedefs_and_resugaring-d1.h"  // for MyTypedef
