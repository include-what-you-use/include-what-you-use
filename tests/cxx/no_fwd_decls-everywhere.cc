...
// IWYU_ARGS: -Xiwyu --no_fwd_decls=everywhere -I .

// Test that passing the --no_fwd_decls=everywhere switch to IWYU suggests including the
...
tests/cxx/no_fwd_decls-everywhere.cc should add these lines:
#include "tests/cxx/indirect.h"

tests/cxx/no_fwd_decls-everywhere.cc should remove these lines:
- #include "tests/cxx/direct.h"  // lines XX-XX
- class Fwd;  // lines XX-XX

The full include-list for tests/cxx/no_fwd_decls-everywhere.cc:
