...
class OneIwyuTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    flags_map = {
      ...
      'tolerate_transitive.cc': ['--tolerate_transitive'],
      'tolerate_transitive_iwyu.cc': ['--tolerate_transitive'],
      'tolerate_transitive_iwyu_both.cc': ['--tolerate_transitive'],
      'tolerate_transitive_iwyu_none.cc': ['--tolerate_transitive'],
    }
    ...
    include_map = {
      ...
      'tolerate_transitive.cc': ['.'],
      'tolerate_transitive_iwyu.cc': ['.'],
      'tolerate_transitive_iwyu_both.cc': ['.'],
      'tolerate_transitive_iwyu_none.cc': ['.'],
