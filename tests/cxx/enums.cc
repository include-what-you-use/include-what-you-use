...
// This trick is used in some enum reflection libraries. Test that IWYU detects
// such uses correctly and requires complete enum types so that item names are
