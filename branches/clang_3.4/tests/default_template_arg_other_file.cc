...
#include "tests/default_template_arg_other_file-d1.h"  // for IntendsToProvideClass (ptr only), IntendsToProvideTplClass (ptr only), TemplateStruct
#include "tests/default_template_arg_other_file-i2.h"  // for MyClass (ptr only), OperateOn, TplClass (ptr only)
